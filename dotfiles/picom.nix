...
stdenv.mkDerivation rec {
  ...
  meta = with lib; {
    description = "Dukk/Picom: A fork of Ft-Labs/Picom, a fork of Picom, a fork of Compton, a fork of XCompMgr-Dana, a fork of XCompMgr, a sample compositing manager for X servers";
    longDescription = ''
